...
const LandingPage = () => {
  const benefits = [
    {
      ...
      description: "Gere documentação completa em minutos, não em horas. Nossa IA analisa seu código automaticamente."
    },
    {
      icon: FileText,
      title: "Documentação Profissional",
      description: "Crie manuais, guias técnicos e documentação de API com formatação profissional e padronizada."
    },
    {
      icon: Brain,
      title: "Inteligência Artificial",
      description: "IA avançada que compreende seu código e gera documentação contextual e relevante."
    }
  ];
  ...
  const features = [
    ...
    { icon: Download, text: "Exportação em diversos formatos" }
  ];
      ...
      <section className="py-20 px-4 text-center bg-gradient-to-br from-background via-background to-muted/20">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-6 leading-tight">
            Gere documentação automática e inteligente
          </h1>
